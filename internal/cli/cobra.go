...
func (app App) NewCommand(stdout, stderr io.Writer) *cobra.Command {
	...
	root.AddCommand(
		...
		app.legacyCommand("decisions", "Migrate legacy decision metadata.", func(args []string, out, errout io.Writer) int { return runDecisions(args, out, errout) }, stdout, stderr),
	)
