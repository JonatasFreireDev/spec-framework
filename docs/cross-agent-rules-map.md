...
| P0 | Produzir relatório com mudanças, decisões, validações, blockers, gaps, correções e riscos residuais | `AGENTS.md`, skills de auditoria/review | Contrato comum do runtime | Deve declarar explicitamente quando não houver gaps conhecidos. |
