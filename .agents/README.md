...
This folder stores agent-facing assets that belong to this repository. It keeps the framework skills inside the project so an agent can read and use them with the product documents they govern.

## When To Use

Use this folder when maintaining repository-local skills and skill metadata. Do not store product artifacts here.
...
- `skills/`: repository-local maintenance skills. They are not mirrored into adopter repositories.
...
| `.agents/skills/` | Repository maintenance skills | Reviewing, testing, packaging, and preserving this repository. |
...
- Do not edit generated agent trees as canonical sources or create product artifacts under `.agents/`.
