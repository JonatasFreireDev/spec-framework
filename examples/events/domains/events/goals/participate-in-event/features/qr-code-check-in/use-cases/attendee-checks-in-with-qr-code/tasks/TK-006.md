...
This QA task verifies or assembles evidence for `REQ-001`, `REQ-002`, `REQ-003`,
`REQ-004`, `REQ-005`, `REQ-006`, `REQ-007`, `REQ-008`, and `REQ-009`, including
their observable criteria `AC-001`, `AC-002`, `AC-003`, `AC-004`, `AC-005`,
`AC-006`, `AC-007`, `AC-008`, and `AC-009`. Implementation tasks retain the
concern-specific write ownership; this mapping prevents evidence from becoming
detached from the complete v2 contract.
