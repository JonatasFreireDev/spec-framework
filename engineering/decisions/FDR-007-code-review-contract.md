...
Create `.codex/skills/code-review/SKILL.md` and `knowledge/templates/code-review-template.md`.
...
| Artifact | Link |
| --- | --- |
| Code Review skill | [../../.codex/skills/code-review/SKILL.md](../../.codex/skills/code-review/SKILL.md) |
| Code Review template | [../../knowledge/templates/code-review-template.md](../../knowledge/templates/code-review-template.md) |
