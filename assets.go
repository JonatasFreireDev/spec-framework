...
//
//go:embed FRAMEWORK.md all:starter all:examples/events framework/AGENTS.framework.md framework/delivery-closure.md framework/decisions framework/init framework/skills framework/template
var Assets embed.FS
