# Organizer Validates QR Code

## Purpose

This folder documents the organizer-facing interaction for scanning and validating an attendee QR code at an event.

## When To Use

Use this use case when specifying, designing, planning, testing, or auditing organizer validation of event attendance.
