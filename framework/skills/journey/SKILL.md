---
name: journey
description: "Journey Skill. Use when an agent needs to Map the end-to-end journey for a user goal and expose moments, states, gaps, and decisions in the Spec Framework workflow, including creating, updating, auditing, explaining, routing, or handing off related product artifacts."
---
...
- This skill owns its generation resources: `assets/journey-template.md`.
