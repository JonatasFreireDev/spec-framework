...
- [ ] The feature traces to one domain, user goal, evidenced problem, and approved boundaries.
- [ ] Scope, non-goals, delivery slice, level, priority, dependencies, and use cases agree.
- [ ] UX, data, permissions, analytics, risks, and relevant decisions are addressed.
- [ ] Approval status and next handoff do not advance unresolved product questions.
