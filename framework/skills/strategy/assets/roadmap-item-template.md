...
- [ ] The item traces to strategy, outcome, level, priority, and measurable success.
- [ ] Scope, non-goals, dependencies, candidate artifacts, and sequencing are explicit.
- [ ] Risks, trade-offs, evidence, decisions, and ownership are current.
- [ ] Approval does not imply implementation commitment beyond the defined delivery boundary.
