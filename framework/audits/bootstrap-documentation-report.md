...
| File | Purpose |
| --- | --- |
| `framework/template/README.md` | Template catalog and usage. |
| `framework/template/journey-template.md` | Journey artifact shape. |
| `framework/template/persona-template.md` | Persona artifact shape. |
| `framework/template/metric-template.md` | Metric artifact shape. |
| `framework/template/roadmap-item-template.md` | Roadmap item artifact shape. |
| `framework/template/release-template.md` | Release artifact shape. |
