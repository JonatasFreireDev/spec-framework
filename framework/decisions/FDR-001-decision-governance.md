...
| Framework decision | `framework/decisions/FDR-*` or explicit `FRAMEWORK.md` amendment | Framework method, skill contract, gates, validator behavior, orchestration, and workflow policy. |
...
| Section | Amendment |
| --- | --- |
| `12. Decisoes` | Clarify that product decisions live in `knowledge/decisions/`, while framework decisions live in `framework/decisions/FDR-*` or as amendments to `FRAMEWORK.md`. |
