...
- Specialist skills: problem, vision, strategy, domain, goal, journey, feature, use case, UX/UI, specification, implementation planning, graph, task, code runner, bug fixer, QA, code review, security review, audit, documentation, and history.
